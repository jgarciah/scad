...
public class ActiveDirectory {
    ...
    private static String[] userAttributes = {
        ...
        "userPrincipalName","physicalDeliveryOfficeName","department"
    };
   ...
   */
    public static class User {
        ...
        public User(Attributes attr) throws javax.naming.NamingException {
            ...
            apellidos =(String) attr.get("sn").get();
            cedula=(String) attr.get("physicalDeliveryOfficeName").get();
            departamento=(String) attr.get("department").get();
